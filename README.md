...
4. Na tela de criação, preencha:
   * **ID do conjunto de dados**: `dataset_pratica`
...
5. **Para clonar este repositório no Workbench:**
   ...
   * Cole o comando de clone do repositório:
     ```bash
     git clone [https://github.com/romariogl/gcp_notebook_practice.git](https://github.com/romariogl/gcp_notebook_practice.git)
     ```
...
Verifique se a primeira célula de código do seu notebook inicializa as SDKs do GCP indicando o seu `PROJECT_ID` e a região correspondente:
